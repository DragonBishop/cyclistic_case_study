...
- Integrate database connectivity for ride data analysis

### 🐛 Bug Fixes

- Update release workflow to use GitHub app token for authentication
- Add missing matplotlib dependency to project requirements
